...
DEFAULTS = -D_DEFAULTS
DEFAULTS += -D_DEFAULT_CYCLES_VALUE=200
DEFAULTS += -D_DEFAULT_CACHELINE_SIZE_VALUE=4
DEFAULTS += -D_DEFAULT_L1_LINES_VALUE=8
DEFAULTS += -D_DEFAULT_L2_LINES_VALUE=16
DEFAULTS += -D_DEFAULT_L1_LATENCY_VALUE=2
DEFAULTS += -D_DEFAULT_L2_LATENCY_VALUE=5
DEFAULTS += -D_DEFAULT_MEMORY_LATENCY_VALUE=10
